...
class ViewController: UIViewController {
    ...
    @IBOutlet var score: CustomButton!
    @IBOutlet var timeMin: CustomButton!
    @IBOutlet var timeSec: CustomButton!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        _ = Timer.scheduledTimer(withTimeInterval: 1, repeats: true, block: {z in
            self.timeSecInt += 1
            if(self.timeSecInt==60){
                self.timeSecInt=0
                self.timeMinInt+=1
            }
            self.timeSec.setTitle(String(self.timeSecInt), for: .normal)
            self.timeMin.setTitle(String(self.timeMinInt), for: .normal)
        })
    ...
    @IBAction func changeButton(_ sender:UIButton){
        ...
        func checkisRight(row: Int, col: Int){
            ...
            if isCorrect != false{
                ...
                scoreInt = scoreInt + 1
                score.setTitle(String(scoreInt), for: .normal)
